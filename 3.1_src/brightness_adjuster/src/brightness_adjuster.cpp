//=============================================================================
// Authors : Joran Farber & Deborah Schrag  
// Group : 
// License : LGPL open source license
//
// Brief : A node that checks if the light is on or off via a manually set threshhold (set as ROS2 param)
//         Subscribed to /image -> computation in this node -> publishes bool to /light_on
//
//=============================================================================
